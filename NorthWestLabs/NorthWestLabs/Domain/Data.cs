...
namespace NorthWestLabs.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 19, nameOption = "Reporting", controller = "Home", action = "Reports", imageClass = "fa fa-table fa-fw", status = true, isParent = false, parentId = 0 });
